      ...
      {/* /* About */ }
        <Box bg={sectionBg} p={5} borderRadius="md" mb={10}>
          ...
          <VStack spacing={4} align="start">
            ...
            <GridItem colSpan={[2, 1]}>
          <Image src="/public/images/about_us.JPG" alt="Company pic" borderRadius="md" objectFit="cover" boxSize="500px" />
            </GridItem>
          </Grid>
        </Box>
      ...
      <Box bg={sectionBg} p={5} borderRadius="md" mb={10}>
        ...
        <Grid templateColumns={['1fr', '1fr 1fr 1fr']} gap={6}>
          ...
          <GridItem>
            ...
            <Text mt={2} fontSize={['sm', 'md']} textAlign="center" fontFamily="Poppins, sans-serif">Peter Smir</Text>
